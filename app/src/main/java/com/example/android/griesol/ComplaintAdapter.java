...
public class ComplaintAdapter extends RecyclerView.Adapter<ComplaintAdapter.ViewHolder>{
    ...
    public interface OnViewClickListener {
        ...
        void onUpVoteClick(JSONObject object);
    ...
    public void onBindViewHolder(@NonNull ComplaintAdapter.ViewHolder holder, int position) {
        ...
        if(upVoted){
            holder.upVoteView.setBackgroundResource(R.drawable.green_upvote_button);
            holder.upVoteView.setClickable(false);
            holder.downVoteView.setVisibility(View.INVISIBLE);
        }else{
            holder.upVoteView.setBackgroundResource(R.drawable.white_upvote_button);
        ...
        holder.upVoteView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    listener.onUpVoteClick(jsonArrayComplaint.getJSONObject(position));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
